            ...
            <div class="box-body">
              <form role="form" method="post"  class="form-horizontal" action="" enctype="multipart/form-data">
                  <div class="box-body">
                      ...
                      <input type="date" min='2023-09-15' max='2023-11-30' class="form-control" placeholder="Start Date" name="from" id="cfrom" value="<?php echo $s_res->c_start;  ?>" />
                    </div>
                    <div class="form-group">
                      <label>End Date</label>
                      <input type="date" min='2023-09-15' max='2023-11-30' class="form-control" placeholder="End Date" name="to" id="cto" value="<?php echo $s_res->c_ends;  ?>" />
                    </div>
