          ...
          <div class="box">
            ...
            <div class="row">
                      ...
                      <select class="form-control" name="prize" id="prize" required >
                        ...
                        <option value="50" <?php if($pr_res->prize=='50'){ echo 'selected="selected"';} ?> >50% Coupon</option>
                        <option value="wm" <?php if($pr_res->prize=='wm'){ echo 'selected="selected"';} ?> >Bosch Washing Machine</option>
                        <option value="bh100" <?php if($pr_res->prize=='bh100'){ echo 'selected="selected"';} ?> >BH 100</option>
                        <option value="omr100" <?php if($pr_res->prize=='omr100'){ echo 'selected="selected"';} ?> >OMR 100</option>
                      </select>
                    </div>
