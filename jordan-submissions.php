...
$sql="select * from `".TB_pre."shop_win` WHERE `zone_country` ='jordan'  ORDER BY entry_id DESC ";
...
?>                           
            ...
            <td><?php echo $res['emirate']; ?></td>
						<td><a download="<?php echo $res["invoice_img"]; ?>" href="../Administrator987/uploads/<?php echo $res["invoice_img"]; ?>"><?php echo ltrim($res['invoice_no'], 'jordan'); ?></a></td>
