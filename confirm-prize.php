...
////
$sql="select * from `".TB_pre."shop_win` WHERE `entry_id` = '$eid'  ORDER BY entry_id DESC ";

$r1=mysqli_query($url,$sql) or die("Failed".mysqli_error($url));
$br1=mysqli_query($url,$sql) or die("Failed".mysqli_error($url));

$basicDetails = mysqli_fetch_array($br1);
$name = $basicDetails['full_name'];
$sessionEmail = $basicDetails['email'];
...
if(isset($_REQUEST['btnapprove'])){
  ...
  if (isset($coupon)) {
    ...
    $message .= '<img src="https://winwithpersil.com/demo/assets/images/email-logo.png" alt="Persil" >' ;
    $message .= '</td>';
    $message .= '</tr>';
    ...
    $headers .= 'From: noreplywinwithpersil.com' . "\r\n";
    $headers .= 'Reply-To: noreplywinwithpersil.com' . "\r\n";
        ...
        <section class="content">
          ...
          <div class="box">
            ...
            <tr>
						<th>Product Image</th>
                        <td><?php if($res["product_img"]!=""){ ?>
                      <img src="../PersilAdmin/uploads/<?php //if($res['is_arabic']==1) {echo ('../ar/uploads/');} else {echo ('../uploads/');} ?><?php echo $res["product_img"]; ?>" />
                      <?php } else{ echo "No-image";} ?></td>
						</tr>
