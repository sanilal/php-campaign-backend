...
<html>
  <head>
    ...
    <title>Hisense | Admin panel </title>
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="home.php" class="logo admin-logo">
          ...
          <span class="logo-mini"> <img src="dist/img/hisens.png" alt=""/></span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><img src="dist/img/hisens.png" class="img-responsive" alt=""/></span>
        </a>
