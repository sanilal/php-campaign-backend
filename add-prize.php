...
?>
              ...
              <form role="form" method="post"action="" enctype="multipart/form-data">
                  <div class="box-body">
                      ...
                      <select class="form-control" name="prize" id="prize" required >
                        ...
                        <option value="50">50% Coupon</option>
                        <option value="wm">Bosch Washing Machine</option>
                        <option value="bh100">BH 100</option>
                        <option value="omr100">OMR 100</option>
    ...
    <?php 
        if ($res['prize'] === 'bh100') {
            ...
            echo '50%';
        } elseif ($res['prize'] === 'omr100') {
            echo 'OMR 100';
        } else {
            echo 'Bosch Washing Machine';
        }
    ?>
</td>
		
                        <td><a href="edit-prize.php?pid=<?php echo $res['pid']; ?>" style="width:100px;" class="btn btn-primary" title="">Edit</a></td>
