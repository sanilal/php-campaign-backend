          ...
          <div class="box">
            ...
            <div class="box-body">
             ...
             <td><?php 
                        ...
                        <td><?php if( $res['prize'] === '50') {echo '50% Coupon'; } elseif($res['prize']==='bh100') {echo 'BHD 100'; }else{echo 'Bosch Washing Machine'; } ?></td>
		
                        <td>
                        <?php if($res['confirm'] == 1) {?>
<div class="btn btn-success">Prize Claimed</div>
      <?php } else { ?>  
                        <a href="edit-prize.php?pid=<?php echo $res['pid']; ?>" style="width:100px;" class="btn btn-primary" title="">Edit</a></td> <?php } ?>
